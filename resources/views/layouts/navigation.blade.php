<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <x-application-logo :show-subtitle="true" />
                </div>
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('snmp_profiles.view')
                        <x-nav-link :href="route('admin.snmp-profiles.index')" :active="request()->routeIs('admin.snmp-profiles.*')">
                            Profil SNMP
                        </x-nav-link>
                    @endcan
                    @can('devices.view')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('snmp_profiles.view')
                <x-responsive-nav-link :href="route('admin.snmp-profiles.index')" :active="request()->routeIs('admin.snmp-profiles.*')">
                    Profil SNMP
                </x-responsive-nav-link>
            @endcan
            @can('devices.view')
