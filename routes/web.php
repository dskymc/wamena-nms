...
use App\Http\Controllers\Admin\SnmpTrapController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('topology/graph', [TopologyController::class, 'graph'])->name('topology.graph');
        Route::post('topology/discover', [TopologyController::class, 'discover'])->name('topology.discover');
        ...
        Route::get('snmp-traps', [SnmpTrapController::class, 'index'])->name('snmp-traps.index');
        Route::get('snmp-traps/{snmpTrap}', [SnmpTrapController::class, 'show'])->name('snmp-traps.show');
        ...
        Route::post('notification-settings/test-email', [NotificationSettingsController::class, 'testEmail'])->name('notification-settings.test-email');
